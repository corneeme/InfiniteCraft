    ...
    336: function(e, n, t) {
        (function(t) {
            ...
            !function() {
                ...
                r.prototype = {
                        ...
                        void 0 !== e && e >= 0 && e <= 1) {
                            ...
                            for (var i = 0; i < n._howls.length; i++)
                                if (!n._howls[i]._webAudio)
                                    for (var t = n._howls[i]._getSoundIds(), o = 0; o < t.length; o++) {
                                        var r = n._howls[i]._soundById(t[o]);
                    ...
                    mute: function(e) {
                        ...
                        n.ctx || A(),
                        n._muted = e,
                        n.usingWebAudio && n.masterGain.gain.setValueAtTime(e ? 0 : n._volume, d.ctx.currentTime);
                        for (var i = 0; i < n._howls.length; i++)
                            if (!n._howls[i]._webAudio)
                                for (var t = n._howls[i]._getSoundIds(), o = 0; o < t.length; o++) {
                                    var r = n._howls[i]._soundById(t[o]);
                    ...
                    stop: function() {
                        for (var e = this || d, i = 0; i < e._howls.length; i++)
                            e._howls[i].stop();
                        return e
                    },
                    unload: function() {
                        for (var e = this || d, i = e._howls.length - 1; i >= 0; i--)
                            e._howls[i].unload();
                    ...
                    _setupCodecs: function() {
                        ...
                        var t = n.canPlayType("audio/mpeg;").replace(/^no$/, "")
                          ...
                          , r = o.match(/OPR\/([0-6].)/g)
                          , _ = r && parseInt(r[0].split("/")[1], 10) < 33
                          , l = -1 !== o.indexOf("Safari") && -1 === o.indexOf("Chrome")
                          , c = o.match(/Version\/(.*?) /)
                          , f = l && c && parseInt(c[1], 10) < 15;
                        return e._codecs = {
                            mp3: !(_ || !t && !n.canPlayType("audio/mp3;").replace(/^no$/, "")),
                            mpeg: !!t,
                            ...
                            weba: !(f || !n.canPlayType('audio/webm; codecs="vorbis"').replace(/^no$/, "")),
                            webm: !(f || !n.canPlayType('audio/webm; codecs="vorbis"').replace(/^no$/, "")),
                            ...
                            var n = function(t) {
                                ...
                                for (var i = 0; i < e._howls.length; i++)
                                    if (!e._howls[i]._webAudio)
                                        for (var r = e._howls[i]._getSoundIds(), d = 0; d < r.length; d++) {
                                            var _ = e._howls[i]._soundById(r[d]);
                                            _ && _._node && !_._node._unlocked && (_._node._unlocked = !0,
                                            _._node.load())
                                        }
                                e._autoResume();
                                var source = e.ctx.createBufferSource();
                                source.buffer = e._scratchBuffer,
                                source.connect(e.ctx.destination),
                    ...
                    _releaseHtml5Audio: function(audio) {
                        var e = this || d;
                        return audio._unlocked && e._html5AudioPool.push(audio),
                        e
                    },
                    _autoSuspend: function() {
                        var e = this;
                        if (e.autoSuspend && e.ctx && void 0 !== e.ctx.suspend && d.usingWebAudio) {
                            for (var i = 0; i < e._howls.length; i++)
                                if (e._howls[i]._webAudio)
                                    for (var n = 0; n < e._howls[i]._sounds.length; n++)
                                        if (!e._howls[i]._sounds[n]._paused)
                                            return e;
                    ...
                    _autoResume: function() {
                        var e = this;
                        if (e.ctx && void 0 !== e.ctx.resume && d.usingWebAudio)
                ...
                _.prototype = {
                    init: function(e) {
                        ...
                        n._onresume = [],
                        n._webAudio = d.usingWebAudio && !n._html5,
                        void 0 !== d.ctx && d.ctx && d.autoUnlock && d._unlockAudio(),
                        d._howls.push(n),
                    ...
                    load: function() {
                        ...
                        if (d.noAudio)
                            ...
                            for (var i = 0; i < e._src.length; i++) {
                                var t, o;
                                if (e._format && e._format[i])
                                    t = e._format[i];
                                else {
                                    if ("string" != typeof (o = e._src[i])) {
                                        e._emit("loaderror", null, "Non-string found in selected audio sources - ignoring.");
                                        continue
                                    }
                                    (t = /^data:audio\/([^;,]+);/i.exec(o)) || (t = /\.([^.]+)$/.exec(o.split("?", 1)[0])),
                                    t && (t = t[1].toLowerCase())
                                }
                    ...
                    play: function(e, n) {
                        ...
                        if ("number" == typeof e)
                            ...
                            !t._playLock)) {
                                for (var r = 0, i = 0; i < t._sounds.length; i++)
                                    t._sounds[i]._paused && !t._sounds[i]._ended && (r++,
                                    o = t._sounds[i]._id);
                                1 === r ? e = null : o = null
                            }
                        }
                        var _ = o ? t._soundById(o) : t._inactiveSound();
                        if (!_)
                            return null;
                        if (o && !e && (e = _._sprite || "__default"),
                        "loaded" !== t._state) {
                            _._sprite = e,
                            _._ended = !1;
                            var l = _._id;
                        ...
                        if (o && !_._paused)
                            ...
                            _._id;
                        t._webAudio && d._autoResume();
                        var c = Math.max(0, _._seek > 0 ? _._seek : t._sprite[e][0] / 1e3)
                          , f = Math.max(0, (t._sprite[e][0] + t._sprite[e][1]) / 1e3 - c)
                          , m = 1e3 * f / Math.abs(_._rate)
                          , v = t._sprite[e][0] / 1e3
                          , h = (t._sprite[e][0] + t._sprite[e][1]) / 1e3;
                        _._sprite = e,
                        _._ended = !1;
                        var A = function() {
                            _._paused = !1,
                        ...
                        if (!(c >= h)) {
                            ...
                            if (t._webAudio) {
                                var w = function() {
                                    ...
                                    A(),
                                    t._refreshBuffer(_);
                                    var e = _._muted || t._muted ? 0 : _._volume;
                                    y.gain.setValueAtTime(e, d.ctx.currentTime),
                                    _._playStart = d.ctx.currentTime,
                                    void 0 === y.bufferSource.start ? _._loop ? y.bufferSource.noteGrainOn(0, c, 86400) : y.bufferSource.noteGrainOn(0, c, f) : _._loop ? y.bufferSource.start(0, c, 86400) : y.bufferSource.start(0, c, f),
                                    m !== 1 / 0 && (t._endTimers[_._id] = setTimeout(t._ended.bind(t, _), m)),
                                ...
                                "running" === d.state && "interrupted" !== d.ctx.state ? w() : (t._playLock = !0,
                                t.once("resume", w),
                                t._clearTimer(_._id))
                            } else {
                                var T = function() {
                                    y.currentTime = c,
                                    y.muted = _._muted || t._muted || d._muted || y.muted,
                                    y.volume = _._volume * d.volume(),
                                    y.playbackRate = _._rate;
                                    try {
                                        var o = y.play();
                                        ...
                                        o.then((function() {
                                            ...
                                            t._playLock = !1,
                                            t._emit("playerror", _._id, "Playback was unable to start. This is most commonly an issue on mobile devices and Chrome where playback was not within a user interaction."),
                                            _._ended = !0,
                                            _._paused = !0
                                        }
                                        ))) : n || (t._playLock = !1,
                                        ...
                                        y.playbackRate = _._rate,
                                        y.paused)
                                            return void t._emit("playerror", _._id, "Playback was unable to start. This is most commonly an issue on mobile devices and Chrome where playback was not within a user interaction.");
                                        "__default" !== e || _._loop ? t._endTimers[_._id] = setTimeout(t._ended.bind(t, _), m) : (t._endTimers[_._id] = function() {
                                            t._ended(_),
                                            y.removeEventListener("ended", t._endTimers[_._id], !1)
                                        }
                                        ,
                                        y.addEventListener("ended", t._endTimers[_._id], !1))
                                    } catch (e) {
                                        t._emit("playerror", _._id, e)
                                    }
                                };
                                "data:audio/wav;base64,UklGRigAAABXQVZFZm10IBIAAAABAAEARKwAAIhYAQACABAAAABkYXRhAgAAAAEA" === y.src && (y.src = t._src,
                                y.load());
                                var x = window && window.ejecta || !y.readyState && d._navigator.isCocoonJS;
                                if (y.readyState >= 3 || x)
                                    T();
                                else {
                                    t._playLock = !0,
                                    ...
                                    var S = function() {
                                        t._state = "loaded",
                                        T(),
                                        y.removeEventListener(d._canPlayEvent, S, !1)
                                    };
                                    y.addEventListener(d._canPlayEvent, S, !1),
                                    t._clearTimer(_._id)
                                }
                            }
                            return _._id
                    ...
                    pause: function(e) {
                        ...
                        if ("loaded" !== n._state || n._playLock)
                            ...
                            n;
                        for (var t = n._getSoundIds(e), i = 0; i < t.length; i++) {
                            n._clearTimer(t[i]);
                            var o = n._soundById(t[i]);
                            if (o && !o._paused && (o._seek = n.seek(t[i]),
                            o._rateSeek = 0,
                            o._paused = !0,
                            n._stopFade(t[i]),
                            o._node))
                    ...
                    stop: function(e, n) {
                        ...
                        for (var o = t._getSoundIds(e), i = 0; i < o.length; i++) {
                            t._clearTimer(o[i]);
                            var r = t._soundById(o[i]);
                            r && (r._seek = r._start || 0,
                            r._rateSeek = 0,
                            r._paused = !0,
                            r._ended = !0,
                            t._stopFade(o[i]),
                            r._node && (t._webAudio ? r._node.bufferSource && (void 0 === r._node.bufferSource.stop ? r._node.bufferSource.noteOff(0) : r._node.bufferSource.stop(0),
                            t._cleanBuffer(r._node)) : isNaN(r._node.duration) && r._node.duration !== 1 / 0 || (r._node.currentTime = r._start || 0,
                            r._node.pause(),
                            r._node.duration === 1 / 0 && t._clearSound(r._node))),
                            n || t._emit("stop", r._id))
                        }
                        return t
                    },
                    mute: function(e, n) {
                        ...
                        for (var o = t._getSoundIds(n), i = 0; i < o.length; i++) {
                            var r = t._soundById(o[i]);
                            r && (r._muted = e,
                            r._interval && t._stopFade(r._id),
                            t._webAudio && r._node ? r._node.gain.setValueAtTime(e ? 0 : r._volume, d.ctx.currentTime) : r._node && (r._node.muted = !!d._muted || e),
                            t._emit("mute", r._id))
                        }
                        return t
                    },
                    volume: function() {
                        ...
                        if (1 === r.length || 2 === r.length && void 0 === r[1]) {
                            var _ = o._getSoundIds()
                              , l = _.indexOf(r[0]);
                            l >= 0 ? n = parseInt(r[0], 10) : e = parseFloat(r[0])
                        } else
                        ...
                        if ("loaded" !== o._state || o._playLock)
                            ...
                            o;
                        void 0 === n && (o._volume = e),
                        n = o._getSoundIds(n);
                        for (var i = 0; i < n.length; i++)
                            (t = o._soundById(n[i])) && (t._volume = e,
                            r[2] || o._stopFade(n[i]),
                            o._webAudio && t._node && !t._muted ? t._node.gain.setValueAtTime(e, d.ctx.currentTime) : t._node && !t._muted && (t._node.volume = e * d.volume()),
                    ...
                    fade: function(e, n, t, o) {
                        ...
                        t = parseFloat(t),
                        r.volume(e, o);
                        for (var _ = r._getSoundIds(o), i = 0; i < _.length; i++) {
                            var l = r._soundById(_[i]);
                            if (l) {
                                if (o || r._stopFade(_[i]),
                                r._webAudio && !l._muted) {
                                    var c = d.ctx.currentTime
                                      , f = c + t / 1e3;
                                    l._volume = e,
                                    l._node.gain.setValueAtTime(e, c),
                                    l._node.gain.linearRampToValueAtTime(n, f)
                                }
                                r._startFadeInterval(l, e, n, t, _[i], void 0 === o)
                            }
                        }
                        return r
                    },
                    _startFadeInterval: function(e, n, t, o, r, d) {
                        var _ = this
                          , l = n
                          , c = t - n
                          , f = Math.abs(c / .01)
                          , m = Math.max(4, f > 0 ? o / f : o)
                          , v = Date.now();
                        e._fadeTo = t,
                        e._interval = setInterval((function() {
                            ...
                            l = c < 0 ? Math.max(t, l) : Math.min(t, l),
                            _._webAudio ? e._volume = l : _.volume(l, e._id, !0),
                            d && (_._volume = l),
                            (t < n && l <= t || t > n && l >= t) && (clearInterval(e._interval),
                            e._interval = null,
                            e._fadeTo = null,
                            _.volume(t, e._id),
                            _._emit("fade", e._id))
                    ...
                    _stopFade: function(e) {
                        var n = this
                          , t = n._soundById(e);
                        return t && t._interval && (n._webAudio && t._node.gain.cancelScheduledValues(d.ctx.currentTime),
                    ...
                    loop: function() {
                        ...
                        if (1 === r.length) {
                            ...
                            2 === r.length && (e = r[0],
                            n = parseInt(r[1], 10));
                        for (var d = o._getSoundIds(n), i = 0; i < d.length; i++)
                            (t = o._soundById(d[i])) && (t._loop = e,
                    ...
                    rate: function() {
                        ...
                        for (var i = 0; i < n.length; i++)
                            if (t = o._soundById(n[i])) {
                                o.playing(n[i]) && (t._rateSeek = o.seek(n[i]),
                                t._playStart = o._webAudio ? d.ctx.currentTime : t._playStart),
                                t._rate = e,
                                o._webAudio && t._node && t._node.bufferSource ? t._node.bufferSource.playbackRate.setValueAtTime(e, d.ctx.currentTime) : t._node && (t._node.playbackRate = e);
                                var c = o.seek(n[i])
                                  , f = (o._sprite[t._sprite][0] + o._sprite[t._sprite][1]) / 1e3 - c
                                  , m = 1e3 * f / Math.abs(t._rate);
                                !o._endTimers[n[i]] && t._paused || (o._clearTimer(n[i]),
                                o._endTimers[n[i]] = setTimeout(o._ended.bind(o, t), m)),
                                o._emit("rate", t._id)
                            }
                        return o
                    },
                    seek: function() {
                        ...
                        if (0 === o.length)
                            ...
                            var r = t._getSoundIds()
                              , _ = r.indexOf(o[0]);
                            _ >= 0 ? n = parseInt(o[0], 10) : t._sounds.length && (n = t._sounds[0]._id,
                            e = parseFloat(o[0]))
                        } else
                        ...
                        if ("number" == typeof e && ("loaded" !== t._state || t._playLock))
                            ...
                            t;
                        var l = t._soundById(n);
                        if (l) {
                            if (!("number" == typeof e && e >= 0)) {
                                if (t._webAudio) {
                                    var c = t.playing(n) ? d.ctx.currentTime - l._playStart : 0
                                      , f = l._rateSeek ? l._rateSeek - l._seek : 0;
                                    return l._seek + (f + c * Math.abs(l._rate))
                                }
                            ...
                            l._ended = !1,
                            t._clearTimer(n),
                            t._webAudio || !l._node || isNaN(l._node.duration) || (l._node.currentTime = e);
                            var v = function() {
                                m && t.play(n, !0),
                                t._emit("seek", n)
                            };
                    ...
                    playing: function(e) {
                        ...
                        for (var i = 0; i < n._sounds.length; i++)
                            if (!n._sounds[i]._paused)
                                return !0;
                        return !1
                    },
                    duration: function(e) {
                    ...
                    unload: function() {
                        for (var e = this, n = e._sounds, i = 0; i < n.length; i++)
                            ...
                            e._webAudio || (e._clearSound(n[i]._node),
                            n[i]._node.removeEventListener("error", n[i]._errorFn, !1),
                            n[i]._node.removeEventListener(d._canPlayEvent, n[i]._loadFn, !1),
                            n[i]._node.removeEventListener("ended", n[i]._endFn, !1),
                            d._releaseHtml5Audio(n[i]._node)),
                            delete n[i]._node,
                            e._clearTimer(n[i]._id);
                        var t = d._howls.indexOf(e);
                        t >= 0 && d._howls.splice(t, 1);
                        var o = !0;
                        for (i = 0; i < d._howls.length; i++)
                            if (d._howls[i]._src === e._src || e._src.indexOf(d._howls[i]._src) >= 0) {
                                o = !1;
                                break
                            }
                    ...
                    off: function(e, n, t) {
                        ...
                        n || t)
                            ...
                            for (i = 0; i < _.length; i++)
                                0 === _[i].indexOf("_on") && Array.isArray(o[_[i]]) && (o[_[i]] = [])
                        }
                        return o
                    },
                    once: function(e, n, t) {
                        return this.on(e, n, t, 1),
                        this
                    },
                    _emit: function(e, n, t) {
                        for (var o = this, r = o["_on" + e], i = r.length - 1; i >= 0; i--)
                            r[i].id && r[i].id !== n && "load" !== e || (setTimeout(function(e) {
                                e.call(this, n, t)
                            }
                            .bind(o, r[i].fn), 0),
                    ...
                    _ended: function(e) {
                        ...
                        n._webAudio && o) {
                            ...
                            e._seek = e._start || 0,
                            e._rateSeek = 0,
                            e._playStart = d.ctx.currentTime;
                    ...
                    _soundById: function(e) {
                        for (var n = this, i = 0; i < n._sounds.length; i++)
                            if (e === n._sounds[i]._id)
                                return n._sounds[i];
                        return null
                    },
                    ...
                    _getSoundIds: function(e) {
                        if (void 0 === e) {
                            for (var n = [], i = 0; i < this._sounds.length; i++)
                                n.push(this._sounds[i]._id);
                            return n
                        }
                        return [e]
                    },
                    _refreshBuffer: function(e) {
                        return e._node.bufferSource = d.ctx.createBufferSource(),
                        ...
                        e._node.bufferSource.playbackRate.setValueAtTime(e._rate, d.ctx.currentTime),
                        this
                    },
                    _cleanBuffer: function(e) {
                        var n = d._navigator && d._navigator.vendor.indexOf("Apple") >= 0;
                        if (d._scratchBuffer && e.bufferSource && (e.bufferSource.onended = null,
                ...
                l.prototype = {
                    ...
                    create: function() {
                        var e = this
                          , n = e._parent
                          , t = d._muted || e._muted || e._parent._muted ? 0 : e._volume;
                        return n._webAudio ? (e._node = void 0 === d.ctx.createGain ? d.ctx.createGainNode() : d.ctx.createGain(),
                        e._node.gain.setValueAtTime(t, d.ctx.currentTime),
                        e._node.paused = !0,
                        e._node.connect(d.masterGain)) : d.noAudio || (e._node = d._obtainHtml5Audio(),
                        e._errorFn = e._errorListener.bind(e),
                        e._node.addEventListener("error", e._errorFn, !1),
                        e._loadFn = e._loadListener.bind(e),
                        e._node.addEventListener(d._canPlayEvent, e._loadFn, !1),
                        e._endFn = e._endListener.bind(e),
                        e._node.addEventListener("ended", e._endFn, !1),
                        e._node.src = n._src,
                        e._node.preload = !0 === n._preload ? "auto" : n._preload,
                        e._node.volume = t * d.volume(),
                        e._node.load()),
                        e
                    },
                    reset: function() {
                    ...
                    _loadListener: function() {
                        ...
                        n._emit("load"),
                        n._loadQueue()),
                        e._node.removeEventListener(d._canPlayEvent, e._loadFn, !1)
                    },
                ...
                var c = {}
                  , f = function(e) {
                    var n = e._src;
                    if (c[n])
                        return e._duration = c[n].duration,
                        void h(e);
                    if (/^data:[^;]+;base64,/.test(n)) {
                        for (var data = atob(n.split(",")[1]), t = new Uint8Array(data.length), i = 0; i < data.length; ++i)
                            t[i] = data.charCodeAt(i);
                        v(t.buffer, e)
                    } else {
                        ...
                        o.onload = function() {
                            var code = (o.status + "")[0];
                            "0" === code || "2" === code || "3" === code ? v(o.response, e) : e._emit("loaderror", null, "Failed loading audio file with status: " + o.status + ".")
                        }
                        ,
                        o.onerror = function() {
                  ...
                  , v = function(e, n) {
                    ...
                    "undefined" != typeof Promise && 1 === d.ctx.decodeAudioData.length ? d.ctx.decodeAudioData(e).then(o).catch(t) : d.ctx.decodeAudioData(e, o, t)
                }
                  , h = function(e, n) {
                  ...
                  , A = function() {
                    if (d.usingWebAudio) {
                        try {
                            "undefined" != typeof AudioContext ? d.ctx = new AudioContext : "undefined" != typeof webkitAudioContext ? d.ctx = new webkitAudioContext : d.usingWebAudio = !1
                        } catch (e) {
                            d.usingWebAudio = !1
                        }
                        d.ctx || (d.usingWebAudio = !1);
                        var e = /iP(hone|od|ad)/.test(d._navigator && d._navigator.platform)
                          , n = d._navigator && d._navigator.appVersion.match(/OS (\d+)_(\d+)_?(\d+)?/)
                          , t = n ? parseInt(n[1], 10) : null;
                        if (e && t && t < 9) {
                            var o = /safari/.test(d._navigator && d._navigator.userAgent.toLowerCase());
                            d._navigator && !o && (d.usingWebAudio = !1)
                        }
                        d.usingWebAudio && (d.masterGain = void 0 === d.ctx.createGain ? d.ctx.createGainNode() : d.ctx.createGain(),
                        d.masterGain.gain.setValueAtTime(d._muted ? 0 : d._volume, d.ctx.currentTime),
                        d.masterGain.connect(d.ctx.destination)),
                        d._setup()
                    }
                };
                void 0 === (o = function() {
                ...
                n.Howler = d,
                n.Howl = _,
                void 0 !== t ? (t.HowlerGlobal = r,
                t.Howler = d,
                t.Howl = _,
                t.Sound = l) : "undefined" != typeof window && (window.HowlerGlobal = r,
                window.Howler = d,
                window.Howl = _,
                window.Sound = l)
            }(),
            function() {
                ...
                ,
                HowlerGlobal.prototype.orientation = function(e, n, t, o, r, d) {
                    var _ = this;
                    if (!_.ctx || !_.ctx.listener)
                        return _;
                    var l = _._orientation;
                    return n = "number" != typeof n ? l[1] : n,
                    t = "number" != typeof t ? l[2] : t,
                    o = "number" != typeof o ? l[3] : o,
                    r = "number" != typeof r ? l[4] : r,
                    d = "number" != typeof d ? l[5] : d,
                    "number" != typeof e ? l : (_._orientation = [e, n, t, o, r, d],
                    void 0 !== _.ctx.listener.forwardX ? (_.ctx.listener.forwardX.setTargetAtTime(e, Howler.ctx.currentTime, .1),
                    _.ctx.listener.forwardY.setTargetAtTime(n, Howler.ctx.currentTime, .1),
                    _.ctx.listener.forwardZ.setTargetAtTime(t, Howler.ctx.currentTime, .1),
                    _.ctx.listener.upX.setTargetAtTime(o, Howler.ctx.currentTime, .1),
                    _.ctx.listener.upY.setTargetAtTime(r, Howler.ctx.currentTime, .1),
                    _.ctx.listener.upZ.setTargetAtTime(d, Howler.ctx.currentTime, .1)) : _.ctx.listener.setOrientation(e, n, t, o, r, d),
                    _)
                }
                ,
                ...
                Howl.prototype.stereo = function(e, t) {
                    ...
                    for (var d = o._getSoundIds(t), i = 0; i < d.length; i++) {
                        var _ = o._soundById(d[i]);
                        if (_) {
                            if ("number" != typeof e)
                                return _._stereo;
                            _._stereo = e,
                            _._pos = [e, 0, 0],
                            _._node && (_._pannerAttr.panningModel = "equalpower",
                            _._panner && _._panner.pan || n(_, r),
                            "spatial" === r ? void 0 !== _._panner.positionX ? (_._panner.positionX.setValueAtTime(e, Howler.ctx.currentTime),
                            _._panner.positionY.setValueAtTime(0, Howler.ctx.currentTime),
                            _._panner.positionZ.setValueAtTime(0, Howler.ctx.currentTime)) : _._panner.setPosition(e, 0, 0) : _._panner.pan.setValueAtTime(e, Howler.ctx.currentTime)),
                            o._emit("stereo", _._id)
                        }
                    }
                    return o
                }
                ...
                Howl.prototype.pos = function(e, t, o, r) {
                    ...
                    for (var _ = d._getSoundIds(r), i = 0; i < _.length; i++) {
                        var l = d._soundById(_[i]);
                        if (l) {
                            if ("number" != typeof e)
                                return l._pos;
                            l._pos = [e, t, o],
                            l._node && (l._panner && !l._panner.pan || n(l, "spatial"),
                            void 0 !== l._panner.positionX ? (l._panner.positionX.setValueAtTime(e, Howler.ctx.currentTime),
                            l._panner.positionY.setValueAtTime(t, Howler.ctx.currentTime),
                            l._panner.positionZ.setValueAtTime(o, Howler.ctx.currentTime)) : l._panner.setPosition(e, t, o)),
                            d._emit("pos", l._id)
                        }
                    }
                    return d
                ...
                Howl.prototype.orientation = function(e, t, o, r) {
                    ...
                    if ("loaded" !== d._state)
                        return d._queue.push({
                            event: "orientation",
                            action: function() {
                                d.orientation(e, t, o, r)
                            }
                        }),
                        d;
                    if (t = "number" != typeof t ? d._orientation[1] : t,
                    o = "number" != typeof o ? d._orientation[2] : o,
                    void 0 === r) {
                        if ("number" != typeof e)
                    ...
                    for (var _ = d._getSoundIds(r), i = 0; i < _.length; i++) {
                        ...
                        if (l) {
                            ...
                            l._orientation = [e, t, o],
                            l._node && (l._panner || (l._pos || (l._pos = d._pos || [0, 0, -.5]),
                            n(l, "spatial")),
                            void 0 !== l._panner.orientationX ? (l._panner.orientationX.setValueAtTime(e, Howler.ctx.currentTime),
                            l._panner.orientationY.setValueAtTime(t, Howler.ctx.currentTime),
                            l._panner.orientationZ.setValueAtTime(o, Howler.ctx.currentTime)) : l._panner.setOrientation(e, t, o)),
                            d._emit("orientation", l._id)
                        }
                    }
                    return d
                }
                ...
                Howl.prototype.pannerAttr = function() {
                    ...
                    if (1 === d.length) {
                        if ("object" != typeof d[0])
                            return (o = r._soundById(parseInt(d[0], 10))) ? o._pannerAttr : r._pannerAttr;
                        e = d[0],
                        ...
                        2 === d.length && (e = d[0],
                        t = parseInt(d[1], 10));
                    for (var _ = r._getSoundIds(t), i = 0; i < _.length; i++)
                        if (o = r._soundById(_[i])) {
                            var l = o._pannerAttr;
                            l = {
                            ...
                            c.panningModel = l.panningModel) : (o._pos || (o._pos = r._pos || [0, 0, -.5]),
                            n(o, "spatial"))
                        }
                    return r
                }
